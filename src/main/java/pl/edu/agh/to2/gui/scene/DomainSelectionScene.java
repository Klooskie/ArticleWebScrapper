...
public class DomainSelectionScene extends JFXScene {
    ...
    void generateScene() {
        ...
        papButton.setOnAction(e -> {
            ArticleSelectionScene articleSelectionScene = new ArticleSelectionScene(stage, new Domain("https://www.pap.pl"), this);
            stage.setScene(articleSelectionScene.getScene());
        });

        Button pap2Button = new Button("PAP2");
        pap2Button.setOnAction(e -> {
            ArticleSelectionScene articleSelectionScene = new ArticleSelectionScene(stage, new Domain("PAP2"), this);
            stage.setScene(articleSelectionScene.getScene());
        });

        Button pap3Button = new Button("PAP3");
        pap3Button.setOnAction(e -> {
            ArticleSelectionScene articleSelectionScene = new ArticleSelectionScene(stage, new Domain("PAP3"), this);
            stage.setScene(articleSelectionScene.getScene());
        });
